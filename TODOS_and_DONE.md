...
- [ ] Upcoming Events Directory ("Plan Your Season", ideas.md §7): aggregate organizer tour dates into a filterable directory + org-page section; phase 1 = schema + owner/superadmin manual entry + directory page (hand-seed 17 orgs), phase 2 = tour-page scrapers in weekly pipeline, phase 3 = studio planning tools (near-me/shortlist/ICS). Stickiness: orgs won't drop off the list studios book from.
