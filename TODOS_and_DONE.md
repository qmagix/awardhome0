...
- [ ] Upcoming Events phase 2: tour-page scrapers (DanceBug-family first) in the weekly pipeline; phase 3: studio planning tools (near-me, shortlist, ICS export, season digest email).
