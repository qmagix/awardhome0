...
const BASE_URL = 'https://www.dancebug.com/rf/events_list.php?ifid=161';
  ...
  for (const year of yearsToRun) {
    ...
    for (let i = 0; i < links.length; i++) {
      ...
      try {
        ...
        const result = spawnSync('node', ['import_starpower_awards.js', url, locationDateStr], { encoding: 'utf8' });
