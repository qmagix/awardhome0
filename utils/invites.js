...
function buildStudioInvite({ studio, totalAwards, firstPlaces, rank }) {
  ...
  <div style="font-family: Arial, Helvetica, sans-serif; color: #222; max-width: 560px; margin: 0 auto; line-height: 1.55;">
    ...
    <strong>AwardHome</strong> — we aggregate results from 25 competitions (YAGP, KAR, Starpower,
    NYCDA, Showstopper, Rainbow, and more) into a single digital trophy case: over 1.48 million awards
...
I'm Q, founder of AwardHome — the digital trophy case for competitive dance. We aggregate results from events nationwide into beautiful, shareable award pages for dancers and studios: today that's over 1.48 million awards from 3,970+ events across 24 competitions, including YAGP, Starpower, KAR, NYCDA, and Rainbow.
